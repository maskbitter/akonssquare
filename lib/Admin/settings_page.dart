        ...
        builder: (ctx) => AlertDialog(
          ...
          title: Column(
            children: [
              ...
              const Text("Backup Recommended", textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold)),
            ],
          ),
          content: const Text(
        ...
        title: Column(
          children: [
            Container(
              ...
              child: Icon(Icons.info_outline, color: Theme.of(context).colorScheme.primary, size: 40),
            ),
            const SizedBox(height: 16),
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                color: ThemeManager.appThemeNotifier.value == "Outline Theme" 
                    ? ThemeManager.outlineBackground 
                    : (title.toLowerCase().contains("warning") ? Colors.orange.withValues(alpha: 0.1) : Theme.of(context).colorScheme.primary.withValues(alpha: 0.1)),
                shape: BoxShape.circle,
                border: ThemeManager.appThemeNotifier.value == "Outline Theme" 
                    ? Border.all(color: title.toLowerCase().contains("warning") ? Colors.orange : Theme.of(context).colorScheme.primary, width: 1.5) 
                    : null,
              ),
              child: Icon(title.toLowerCase().contains("warning") ? Icons.warning_amber_rounded : Icons.help_outline, color: title.toLowerCase().contains("warning") ? Colors.orange : Theme.of(context).colorScheme.primary, size: 40),
            ),
            const SizedBox(height: 16),
            Text(title, textAlign: TextAlign.center, style: const TextStyle(fontWeight: FontWeight.bold)),
          ],
        ...
        title: Column(
          children: [
            Container(
              ...
              child: Icon(Icons.palette_outlined, color: Theme.of(context).colorScheme.tertiary, size: 40),
            ),
            const SizedBox(height: 16),
            Text("Select Theme", style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.bold)),
          ],
        ),
        content: SizedBox(
          width: MediaQuery.of(context).size.width * 0.95,
          ...
          title: Column(
            children: [
              Container(
                ...
                child: Icon(Icons.color_lens_outlined, color: Theme.of(context).colorScheme.primary, size: 40),
              ),
              const SizedBox(height: 16),
              const Text("Background Customizer", style: TextStyle(fontWeight: FontWeight.bold)),
            ],
          ),
        ...
        title: Column(
          children: [
            Container(
              ...
              child: Icon(docId == null ? Icons.person_add_alt_1_outlined : Icons.manage_accounts_outlined, color: Theme.of(context).colorScheme.primary, size: 40),
            ),
            const SizedBox(height: 16),
            Text(docId == null ? "Add Account" : "Edit Account", style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.bold)),
          ],
        ),
        content: SizedBox(
          width: MediaQuery.of(context).size.width * 0.95,
      ...
      title: Column(
        children: [
          Container(
            ...
            child: Icon(Icons.delete_forever_outlined, color: Theme.of(context).colorScheme.error, size: 40),
          ),
          const SizedBox(height: 16),
          const Text("Remove Account?", style: TextStyle(fontWeight: FontWeight.bold)),
        ],
      ),
      content: Text("Are you sure you want to remove user '$username'?", textAlign: TextAlign.center),
      actions: [
        AppDialogActions(
          actions: [
            AppButton(
