    ...
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: SizedBox(
          ...
          child: const Text("A previous database operation (Restore/Delete) was interrupted or failed. Would you like to rollback to the safe state or ignore?", textAlign: TextAlign.center),
        ),
        actions: [
          AppDialogActions(
            actions: [
