            ...
            title: Column(
              children: [
                Container(
                  ...
                  child: Icon(Icons.speed_outlined, color: Theme.of(context).colorScheme.tertiary, size: 40),
                ),
                const SizedBox(height: 16),
                Text("Add Main Meter", style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.bold)),
              ],
            ),
            content: SizedBox(
            ...
            title: Column(
              children: [
                Container(
                  ...
                  child: Icon(Icons.speed, color: Theme.of(context).colorScheme.primary, size: 40),
                ),
                const SizedBox(height: 16),
                            ...
                            title: Column(
                              children: [
                                Container(
                                  ...
                                  child: Icon(Icons.sync_outlined, color: Theme.of(context).colorScheme.primary, size: 40),
                                ),
                                const SizedBox(height: 16),
                                Text("Sync Main Meter?", textAlign: TextAlign.center, style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.bold)),
                              ],
                            ),
                            content: SizedBox(
                              width: MediaQuery.of(context).size.width * 0.95,
                              child: Text("Previous reading was $prevSavedMain. Should this be set as the 'Last Reading' for this month?", textAlign: TextAlign.center, style: Theme.of(context).textTheme.bodyMedium),
                            ),
                            actions: [
                              AppDialogActions(
                                actions: [
                          ...
                          builder: (c) => AlertDialog(
                            ...
                            title: Column(
                              children: [
                                ...
                                const SizedBox(height: 16),
                                Text("Sync Govt. Reading?", textAlign: TextAlign.center, style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.bold)),
                              ],
                            ),
                            content: SizedBox(
                              width: MediaQuery.of(context).size.width * 0.95,
                              child: Text("Previous Govt. reading was $prevSavedGovt. Should this be set as the 'Last Govt. Reading' for this month?", textAlign: TextAlign.center, style: Theme.of(context).textTheme.bodyMedium),
                            ),
                            actions: [
                              AppDialogActions(
                                actions: [
            ...
            title: Column(
              children: [
                Container(
                  ...
                  child: Icon(Icons.av_timer_outlined, color: Theme.of(context).colorScheme.tertiary, size: 40),
                ),
                const SizedBox(height: 16),
                Text("Add Sub Meter", style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.bold)),
              ],
            ),
            content: SizedBox(
              width: MediaQuery.of(context).size.width * 0.95,
        ...
        title: Column(
          children: [
            Container(
              ...
              child: Icon(Icons.warning_amber_outlined, color: Theme.of(context).colorScheme.error, size: 40),
            ),
            const SizedBox(height: 16),
            Text("Remove $type?", textAlign: TextAlign.center, style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.bold)),
