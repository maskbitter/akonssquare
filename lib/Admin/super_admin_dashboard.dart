                      ...
                      builder: (context, pSnap) {
                        ...
                        if (dbInfoSnap.hasData && dbInfoSnap.data!.exists) {
                          ...
                          return Column(
                            ...
                            children: [
                              Text("${local}_$bnText", style: Theme.of(context).textTheme.labelSmall?.copyWith(color: Theme.of(context).colorScheme.onPrimary, fontWeight: FontWeight.bold, fontSize: 9)),
