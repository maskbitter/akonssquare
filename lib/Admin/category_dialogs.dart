...
class CategoryDialogs {
  ...
  static void showElectricityDialog({required BuildContext context, required String subItemId, required String subItemName, Map<String, dynamic>? existingData, bool isOperator = false}) => 
      const CategoryDialogs().showElectricityDialog(context: context, subItemId: subItemId, subItemName: subItemName, existingData: existingData, isOperator: isOperator);
  ...
  static void showConfirmDialog({required BuildContext context, required String title, required String content, required VoidCallback onConfirm, String confirmText = "Remove", Color? confirmColor}) => 
      const CategoryDialogs().showConfirmDialog(context: context, title: title, content: content, onConfirm: onConfirm, confirmText: confirmText, confirmColor: confirmColor);
