                      ...
                      Card(
                        ...
                        child: ExpansionTile(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 6),
                            _buildInfoRow("Main Meter:", ed['mainMeterNo'] ?? 'N/A', icon: Icons.settings_input_component),
                            _buildInfoRow("Sub-Meter:", ed['mainSubMeterNo'] ?? 'N/A', icon: Icons.numbers),
                            _buildInfoRow("Last Reading:", "${(ed['lastReading'] as num?)?.toDouble().toStringAsFixed(2)}", icon: Icons.history),
                            _buildInfoRow("Present Reading:", "${(ed['presentReading'] as num?)?.toDouble().toStringAsFixed(2)}", icon: Icons.visibility),
